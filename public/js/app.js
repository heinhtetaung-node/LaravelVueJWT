...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_App_vue__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ExampleComponent_vue__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Register_vue__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_login_vue__ = __webpack_require__(51);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    check: function check() {
        ...
        alert(token);
        if (token !== null) {
            __WEBPACK_IMPORTED_MODULE_0__app_js__["default"].axios.get('api/user?token=' + token).then(function (response) {
    ...
    register: function register(context, name, email, password) {
        __WEBPACK_IMPORTED_MODULE_0__app_js__["default"].axios.post('api/register', { name: name, email: email, password: password }).then(function (response) {
    ...
    signin: function signin(context, email, password) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__app_js__["default"].axios.post('api/signin', {
            email: email,
            password: password
        }).then(function (response) {
            context.error = false;
            localStorage.setItem('id_token', response.data.meta.token);
            __WEBPACK_IMPORTED_MODULE_0__app_js__["default"].axios.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('id_token');
...
var update = __webpack_require__(41)("17b07661", content, false);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__auth_js__ = __webpack_require__(4);
//
//
//
//
            ...
            _c("div", [
              ...
              _vm.success
                ? _c("div", { staticClass: "alert alert-success" }, [
                    _c("p", [
                      _vm._v("Registration completed. You can now sign in.")
                    ])
                  ])
                : _vm._e(),
              _vm._v(" "),
